...
const Recommended = ({ handleClick }) => {
  return (
    <div className="mx-4 md:mx-10 my-5"> {/* Adjusted margins for responsiveness */}
      <h2 className="ml-4 md:ml-10 mb-2 md:mb-5 mt-5 text-xl md:text-2xl font-extrabold">Recommended</h2>
      <div className="flex flex-wrap ml-4 md:ml-0 md:ml-20 space-x-4 md:space-x-6"> {/* Added flex-wrap and adjusted ml for responsive spacing */}
