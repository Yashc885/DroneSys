...
import Slider from './Slider.jsx';  // Ensure Slider.jsx is properly implemented
        ...
        <div className="slider-content py-4 md:py-6 lg:py-8">
          <div className="px-4 md:px-6 lg:px-8">
            ...
            <div className={`nc-SectionHowItWork ${className}`}>
              ...
              <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10 bg-white relative">
                <Image
